...
class ShowNumOFTicketModel {
  int? countPrice6;
  int? countPrice8;
  int? countPrice12;

  ShowNumOFTicketModel({this.countPrice6, this.countPrice8, this.countPrice12});

  ShowNumOFTicketModel.fromJson(Map<String, dynamic> json) {
